...
-u|--url	Specify the URL of the repository. Default is https://github.com/fartcoin-project/fartcoin16
...
then
	...
	make -C ../fartcoin16/depends download SOURCES_PATH=`pwd`/cache/common
