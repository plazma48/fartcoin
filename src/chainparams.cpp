...
static CBlock CreateGenesisBlock(uint32_t nTime, uint32_t nNonce, uint32_t nBits, int32_t nVersion, const CAmount& genesisReward)
{
    ...
    const CScript genesisOutputScript = CScript() << ParseHex("04e5b299024f1ddc80fc2d0113b684cd6ccf1d65079062646f24c16e4d4da86d0179fafd1952262b15ba6096ebe21c14d7643373c8efdd2842e3bd2b76fe1fab8a") << OP_CHECKSIG;
...
public:
	...
	pchMessageStart[0] = 0xf2;
        ...
        genesis = CreateGenesisBlock(1517677771, 370493, 0x1e0ffff0, 1, 100 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x30ab0676db11ce93d84e1ed42699cda2f8c118146e1eb42e51acc1f822f09da5"));
        assert(genesis.hashMerkleRoot == uint256S("0x12078fb53a2b671d420729221dfb16e561774f1dc5633f83ddae3b4f9a164352"));

        // Note that of those with the service bits flag, most only support a subset of possible options
        vSeeds.emplace_back("dnsseed.omariskandarani.com");
        ...
        checkpointData = {
            {
                {  0, uint256S("0x30ab0676db11ce93d84e1ed42699cda2f8c118146e1eb42e51acc1f822f09da5")},
        ...
        chainTxData = ChainTxData{
            ...
            1517677771, // * UNIX timestamp of last known number of transactions
...
public:
	...
	pchMessageStart[0] = 0xf2;
        ...
        genesis = CreateGenesisBlock(1517677746, 192177, 0x1e0ffff0, 1, 100 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xd01f76532b71814710dade3c232590b3da00f3087cdb9a57b7fa19b8b9bde492"));
        assert(genesis.hashMerkleRoot == uint256S("0x12078fb53a2b671d420729221dfb16e561774f1dc5633f83ddae3b4f9a164352"));

        vFixedSeeds.clear();
        vSeeds.clear();
        // nodes with support for servicebits filtering should be at the top
        vSeeds.emplace_back("testnet.omariskandarani.com");
        ...
        checkpointData = (CCheckpointData) {
            {
                {06, uint256S("0xd01f76532b71814710dade3c232590b3da00f3087cdb9a57b7fa19b8b9bde492")},
            }
        };
...
public:
    CRegTestParams() {
        ...
        consensus.nPowTargetTimespan = 144 * 60; // two weeks
        consensus.nPowTargetSpacing = 60;
        consensus.fPowAllowMinDifficultyBlocks = true;
	...
	pchMessageStart[0] = 0xf2;
        ...
        genesis = CreateGenesisBlock(1517777777, 377778, 0x207fffff, 1, 100 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x004297a2851977b5726d0cd8b7f82d29b62a5bd8ae898074458122e4f2c4c732"));
        assert(genesis.hashMerkleRoot == uint256S("0x12078fb53a2b671d420729221dfb16e561774f1dc5633f83ddae3b4f9a164352"));
        ...
        checkpointData = {
            {
                {0, uint256S("0x004297a2851977b5726d0cd8b7f82d29b62a5bd8ae898074458122e4f2c4c732")},
            }
        };
